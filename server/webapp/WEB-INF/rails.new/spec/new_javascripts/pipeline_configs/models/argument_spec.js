...
define(['lodash', 'pipeline_configs/models/argument'], function (_, Argument) {
  describe('Argument create', function () {
    ...
    it('should create a string type in absence of any arguments', function () {
      var argument = Argument.create(undefined, undefined);

      expect(argument.data()).toBe('');
      expect(argument.isList()).toBe(false);
    });
  });
  ...
  describe('Argument toString', function () {
  ...
  describe('Argument toList', function () {
