...
define(["mithril", "lodash", "pipeline_configs/views/lookup_command_widget", "pipeline_configs/models/tasks"], function (m, _, LookupCommandWidget, Tasks) {
  describe("Lookup Command Widget", function () {
    ...
    describe("view", function() {
      ...
      beforeAll(function(){
        model = jasmine.createSpyObj('model', ['command', 'args']);
    ...
    describe('controller', function () {
      describe('selectSnippet', function () {
        ...
        it('should update task command and args where args is a list', function () {
        ...
        it('should update task command and args where args is a string', function () {
          var task = new Tasks.Task.Exec({command: 'ls', args: '-al'});
          var controller = new LookupCommandWidget.controller({
            model:    task,
            snippets: new LookupCommandWidget.Command.Snippets([snippet])
          });
          ...
          expect(task.command()).toEqual(snippet.command());
          expect(task.args().data()).toEqual(snippet.args());
        });
      });
